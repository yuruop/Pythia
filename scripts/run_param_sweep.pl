...
my %algo_configs = (
    'tsetlin' => {
        ...
        categories => {
            ...
            'tsetlin_dsig0'        => 'Feature Eng (P1.3)',
            'tsetlin_dsig8'        => 'Feature Eng (P1.3)',
            'tsetlin_inter8'       => 'Feature Eng (P1.2)',
            'tsetlin_bw4'          => 'Feature Eng (P1.2)',
            'tsetlin_td8'          => 'Feature Eng (P1.2)',
            'tsetlin_td16'         => 'Feature Eng (P1.2)',
            'tsetlin_freq4'        => 'Advanced Feat (P1.4)',
            'tsetlin_conf4'        => 'Advanced Feat (P1.4)',
            'tsetlin_freq4_conf4'  => 'Advanced Feat (P1.4)',
    ...
    'linucb' => {
        ...
        categories => {
            ...
            'linucb_feat8'      => 'Feature Dim (P1.3)',
            'linucb_feat10'     => 'Feature Dim (P1.4)',
            'linucb_feat11'     => 'Feature Dim (P1.4)',
        },
    },
);
